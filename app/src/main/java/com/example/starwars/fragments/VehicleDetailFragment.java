...
import com.example.starwars.databinding.FragmentVehicleDetailBinding;
...
public class VehicleDetailFragment extends Fragment {
    ...
    private VehicleDetailFragmentArgs args;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentVehicleDetailBinding.inflate(inflater, container, false);
        args = VehicleDetailFragmentArgs.fromBundle(getArguments());
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        binding.setVehicle(args.getVehicle());

        binding.vehicleDetailImage.setImageBitmap(args.getImage());
